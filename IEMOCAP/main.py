...
"""
***Best Parameters: [27, 65, 32, 8, 64, 0.0002, 0.1, 1.0, 1.4, 1.0, 0.5, 1e-05] | Best Value: -0.714109673444239
"""
...
def model_test(model, img_test, word_test_1, word_test_2, word_test_3, word_test_4, word_test_all, audio_test,
    ...
    model.eval()
    with torch.no_grad():
        output_test, comple_out, simi_vision, simi_text, simi_audio, _, _ = model(img_test, word_test_1,
...
parser.add_argument("--n_epochs", type=int, default=65, help="")
...
parser.add_argument("--input_size_audio", type=int, default=1582, help="")
parser.add_argument("--label_size", type=int, default=6, help="")
parser.add_argument("--num_speaker", type=int, default=2, help="")
...
parser.add_argument("--weight_decay", type=float, default=0.00001, help="")
parser.add_argument("--patience", type=int, default=10, help="")
parser.add_argument("--model_path", type=str, default='model_parm/IEMOCAP_vla_1024',
                    help="")
