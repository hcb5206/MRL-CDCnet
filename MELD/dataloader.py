...
def dataloader(batch_size):
    ...
    speaker_train = data['speaker_train']

    # print(label_train)
    # counts_dict, counts_dict_por = count_samples_per_class(label_train, 7)
    # print(counts_dict)
    ...
    #       word_train_4.shape, word_train_all.shape, img_train.shape, audio_train.shape, speaker_train.shape)
    ...
    speaker_val = data['speaker_val']

    # print(label_val)
    # counts_dict_val, counts_dict_por_val = count_samples_per_class(label_val, 7)
    ...
    #       img_val.shape, audio_val.shape, speaker_val.shape)
    ...
    speaker_test = data['speaker_test']

    # print(label_test)
    # counts_dict_test, counts_dict_por_test = count_samples_per_class(label_test, 7)
    ...
    #       word_test_4.shape, word_test_all.shape, img_test.shape, audio_test.shape, speaker_test.shape)
