...
"""
task:1
Best Parameters: [2086, 85, 90, 4, 64, 5e-05, 0.2, 0.6, 1.1, 0.4, 0.7, 5e-05] | Best Value: -0.923728813559322
"""
...
parser.add_argument("--task", type=str, default='1', help="")
...
parser.add_argument("--lr_comple", type=float, default=5e-05, help="")
...
parser.add_argument("--l1", type=float, default=0.6, help="Weight for the spatial distance saturation region [0.5, 1.0]")
parser.add_argument("--l2", type=float, default=1.1, help="Weight for the tonal inversion region [1.0, 1.5]")
parser.add_argument("--alpha", type=float, default=0.4, help="Weight for semantic similarity loss [0.0, 1.0]")
parser.add_argument("--p", type=float, default=0.7, help="Differentiation filter threshold [0.0, 0.9]")
parser.add_argument("--weight_decay", type=float, default=5e-05, help="")
parser.add_argument("--patience", type=int, default=10, help="")
parser.add_argument("--model_path", type=str, default='models_parm/comple_fusion_main_JointVAE_2048_1',
                    help="")
